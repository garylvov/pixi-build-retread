...
EXPECT_SHA=SUBSTITUTE_ME_SHA256_OF_THE_GREEN_P5X_BINSNAP
...
LEFTOVER_RE='bfinal|BFP1|BFP2|bfp1|bfp2|b1c|b1-phase|b1b-phase|b2-phase|b2b-phase|b3-phase|ctl-phase|eff-phase|/b1_|/b2_|/b3_|/ctl_|p5sab|P5SAB|p5t_abc|P5TABC|p5u|P5U|p5z|P5Z|p6a|P6A|certB3P1|2cfec88d|57105d38|phase-template-example|PHASEN'
### SUBSTITUTE: END
